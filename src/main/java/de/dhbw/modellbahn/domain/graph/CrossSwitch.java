...
public class CrossSwitch extends GraphPoint implements Switch {
    ...
    public CrossSwitch(GraphPointConnection straight1, GraphPointConnection straight2, GraphPointConnection diverging1, GraphPointConnection diverging2, SwitchComponent switchComponent) {
